...
cv2.setTrackbarPos('threshold','Binary',127)   #127 -> 임계값 수정 가능
...
while(True):
    ...
    ret,img_binary = cv2.threshold(img_gray, low,255, cv2.THRESH_BINARY_INV)  #THRESH_BINARY OR THRESH_BINARY_I NV
